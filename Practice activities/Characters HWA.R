...
name <- "HeatherAshworth"

nchar (name)

animals <- "cat dog bug mouse"
nchar (animals)  
...
x <- c("Open", "Sesame ")
y <- c("You","Suck.")
nchar(x) #this count whatever is between quotes
```

**Then, what is the value of:**
  ```{r,include=TRUE,eval=FALSE}
nchar(c(x,y)) #shows you that you can concatenate two values and then count characters
```
library(stringr)
